...
<body class="nav-md">
	...
	<script data-rocketsrc="../vendors/jquery/dist/jquery.min.js"
		type="text/rocketscript"></script>

	<script data-rocketsrc="../vendors/bootstrap/dist/js/bootstrap.min.js"
		type="text/rocketscript"></script>

	<script data-rocketsrc="../vendors/fastclick/lib/fastclick.js"
		type="text/rocketscript"></script>

	<script data-rocketsrc="../vendors/nprogress/nprogress.js"
		type="text/rocketscript"></script>

	<script data-rocketsrc="../vendors/Chart.js/dist/Chart.min.js"
		type="text/rocketscript"></script>

	<script data-rocketsrc="../vendors/gauge.js/dist/gauge.min.js"
		type="text/rocketscript"></script>

	<script
		data-rocketsrc="../vendors/bootstrap-progressbar/bootstrap-progressbar.min.js"
		type="text/rocketscript"></script>

	<script data-rocketsrc="../vendors/iCheck/icheck.min.js"
		type="text/rocketscript"></script>

	<script data-rocketsrc="../vendors/skycons/skycons.js"
		type="text/rocketscript"></script>

	<script data-rocketsrc="../vendors/Flot/jquery.flot.js"
		type="text/rocketscript"></script>
	<script data-rocketsrc="../vendors/Flot/jquery.flot.pie.js"
		type="text/rocketscript"></script>
	<script data-rocketsrc="../vendors/Flot/jquery.flot.time.js"
		type="text/rocketscript"></script>
	<script data-rocketsrc="../vendors/Flot/jquery.flot.stack.js"
		type="text/rocketscript"></script>
	<script data-rocketsrc="../vendors/Flot/jquery.flot.resize.js"
		type="text/rocketscript"></script>

	<script
		data-rocketsrc="../vendors/flot.orderbars/js/jquery.flot.orderBars.js"
		type="text/rocketscript"></script>
	<script
		data-rocketsrc="../vendors/flot-spline/js/jquery.flot.spline.min.js"
		type="text/rocketscript"></script>
	<script data-rocketsrc="../vendors/flot.curvedlines/curvedLines.js"
		type="text/rocketscript"></script>

	<script data-rocketsrc="../vendors/DateJS/build/date.js"
		type="text/rocketscript"></script>

	<script data-rocketsrc="../vendors/jqvmap/dist/jquery.vmap.js"
		type="text/rocketscript"></script>
	<script
		data-rocketsrc="../vendors/jqvmap/dist/maps/jquery.vmap.world.js"
		type="text/rocketscript"></script>
	<script
		data-rocketsrc="../vendors/jqvmap/examples/js/jquery.vmap.sampledata.js"
		type="text/rocketscript"></script>

	<script data-rocketsrc="../vendors/moment/min/moment.min.js"
		type="text/rocketscript"></script>
	<script
		data-rocketsrc="../vendors/bootstrap-daterangepicker/daterangepicker.js"
		type="text/rocketscript"></script>

	<script data-rocketsrc="../build/js/custom.min.js"
		type="text/rocketscript"></script>
